...
class Game {
    ...
    bindEvents() {
        ...
        // 菜单轮播事件
        document.getElementById('menu-prev').addEventListener('click', () => this.switchMenuPage(-1));
        document.getElementById('menu-next').addEventListener('click', () => this.switchMenuPage(1));
    }
    ...
    switchMenuPage(direction) {
        ...
        if (newIndex < 0) {
            newIndex = pages.length - 1; // 循环到最后一页
        ...
        console.log(`菜单切换到第 ${newIndex + 1} 页`);
    }
